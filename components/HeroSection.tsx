...
export default function Component() {
  return (
    <section className='w-full h-[calc(100vh-130px)] min-h-[667px] max-h-[900px] pt-16 pb-4 px-10 flex flex-col justify-center items-center gap-10 bg-hero-image bg-cover bg-center'>
